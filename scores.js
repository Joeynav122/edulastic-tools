...
function main() {
  let url_regex = /https:\/\/app\.edulastic\.com\/student\/assessment\/([a-f0-9]+)\/class\/([a-f0-9]+)\/testActivityReport\/([a-f0-9]+)/;
  ...
  let request_url = `https://app.edulastic.com/student/assessment/${uta}/report?itemId=${item_id}`;
